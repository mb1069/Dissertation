...
\begin{figure}
	...
	\begin{tikzpicture}
	    ...
	    \end{axis}
	\end{tikzpicture}
	\caption{Average run time $\times$ combined error for each algorithm, using as many generations as possible in time limit, optimal parameters for each algorithm and population of 50.}
...
\begin{figure}
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Performance of each algorithm over 30 executions for various time limits.}
	\label{fig:ga_vs_elite_vs_grid_box_whiskers}
\end{figure}

\chapter{Discussion}
\section{Comparison to classical algorithms}
