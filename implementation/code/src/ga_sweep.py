...
def main(multicore, NGEN, POP, scan, map, CXPB, MUTPB, verb):
    ...
    return evaluate_solution(expr[0], expr[1], expr[2], errorscan.posx, errorscan.posy, errorscan.rot), record, log, expr
        ...
        for MUTPB in b:
            ...
            for x in trange(args.iterations):
                ...
                if args.savefile is not None:
                    row = [CXPB, MUTPB, best_fitness[0] * best_fitness[1], stop-start, expr[0], expr[1], expr[2], "\r"]
